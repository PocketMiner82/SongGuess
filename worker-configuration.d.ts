/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.env.example --env-file=./src/server/worker-configuration.d.ts` (hash: b5c51791433fd2a8524bee615e321884)
// Runtime types generated with workerd@1.20260611.1 2026-05-30 global_fetch_private_origin,nodejs_compat_v2
interface __BaseEnv_Env {
	ASSETS: Fetcher | string;
	"0": string;
	"1": string;
	...
	SongGuessServer: string | DurableObjectNamespace<import("./src/server/index").SongGuessServer>;
	SongGuessAPI: string | DurableObjectNamespace<import("./src/server/index").SongGuessAPI>;
	mainModule: string;
	durableNamespaces: string;
	fetch: string;
	scheduled: string;
	queue: string;
	...
	Cloudflare: string;
	Event: string;
	ExtendableEvent: string;
	CustomEvent: string;
	PromiseRejectionEvent: string;
	FetchEvent: string;
	TailEvent: string;
	TraceEvent: string;
	...
	ReadableStreamBYOBReader: string;
	...
	MessagePort: string;
	EventSource: string;
	ReadableStreamBYOBRequest: string;
	ReadableStreamDefaultController: string;
	ReadableByteStreamController: string;
	WritableStreamDefaultController: string;
	TransformStreamDefaultController: string;
	CompressionStream: string;
	DecompressionStream: string;
	TextEncoderStream: string;
	...
	Response: string;
	WebSocket: string;
	WebSocketPair: string;
	WebSocketRequestResponsePair: string;
	...
	CacheStorage: string;
	Cache: string;
	FixedLengthStream: string;
	IdentityTransformStream: string;
	HTMLRewriter: string;
	code: string;
	message: string;
	success: string;
	...
	cached: string;
	request_size: string;
	request_head_complete: string;
	response_size: string;
	response_head_complete: string;
	...
	bottom: string;
	colo: string;
	edgeRequestKeepAliveStatus: string;
	httpProtocol: string;
	...
	certChainRFC9440TooLarge: string;
	size_after: string;
	rows_read: string;
	rows_written: string;
	last_row_id: string;
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "SongGuessServer" | "SongGuessAPI";
	}
	interface DevEnv {
		ASSETS: Fetcher;
		"0": string;
		...
		latencyMs: string;
		items: string;
		SongGuessServer: DurableObjectNamespace<import("./src/server/index").SongGuessServer>;
		SongGuessAPI: DurableObjectNamespace<import("./src/server/index").SongGuessAPI>;
	}
	interface LocaldevEnv {
		ASSETS: Fetcher;
		"0": string;
		"1": string;
		SOUNDCLOUD_CLIENT_ID: string;
