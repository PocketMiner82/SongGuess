/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/server/worker-configuration.d.ts` (hash: 2f182c04bb8e0e919b22d6c7dfd73b0d)
// Runtime types generated with workerd@1.20260526.1 2026-05-30 global_fetch_private_origin,nodejs_compat_v2
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	VALIDATE_ROOM_TOKEN: string;
	ADMIN_USER: string;
	ADMIN_PASSWORD: string;
	SOUNDCLOUD_CLIENT_ID: string;
	SOUNDCLOUD_CLIENT_SECRET: string;
	SongGuessServer: DurableObjectNamespace<import("./index").SongGuessServer>;
	SongGuessAPI: DurableObjectNamespace<import("./index").SongGuessAPI>;
}
